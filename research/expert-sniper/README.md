...
35B optimizations: REAP dead-expert masking (45% skipped) + routing bias=1.0 + co-activation prefetch. 30B: right-sized LRU + co-activation (REAP/bias not yet applied).
